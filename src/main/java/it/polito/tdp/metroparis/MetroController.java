...
public class MetroController {
    ...
    void handleCerca(ActionEvent event) {
    	...
    	if(partenza!=null && arrivo!=null && !partenza.equals(arrivo)) {
    		...
    		//Polamento tabella fermate:
    		tblPercorso.setItems(FXCollections.observableArrayList(percorso));
    		
    		txtResult.setText("Percorso con "+percorso.size()+" stazioni.");	
    	}
    	else
    		txtResult.setText("Selezionare due stazioni, diverse tra loro.\n");
    ...
    void initialize() {
        ...
        //Inizializzazione tabella fermate:
